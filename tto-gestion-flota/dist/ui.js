...
const SIAGOP_UI = (() => {
    ...
    const instance = {
        ...
        confirm: (title, message, confirmText = 'Aceptar', cancelText = 'Cancelar') => show({ title, message, confirmText, cancelText, type: 'warning' })
    };
...
function mostrarModalConfirmarSalida(CapacitorApp) {
    if (document.getElementById('modal-salir-app'))
        return;
    const modalHTML = `
