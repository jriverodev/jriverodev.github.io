...
async function loadStatistics() {
    try {
        ...
        updateDashboard({
            total: AppState.allReports.length,
            operativas: AppState.allReports.filter(r => r.estado === 'Operativa').length,
            inoperativas: AppState.allReports.filter(r => r.estado === 'Inoperativa').length,
            organizaciones: {}
        });
    }
}
